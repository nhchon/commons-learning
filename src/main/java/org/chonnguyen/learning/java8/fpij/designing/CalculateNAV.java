...
public class CalculateNAV {
    ...
    public static void main(String[] args) {
        final  org.chonnguyen.learning.java8.fpij.designing.CalculateNAV calculateNav = new  org.chonnguyen.learning.java8.fpij.designing.CalculateNAV(YahooFinance::getPrice);
